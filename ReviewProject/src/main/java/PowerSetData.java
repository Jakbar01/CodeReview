...
/** 
 * A class that initializes an array from randumNumber class and
 * runs algorithm based on input from user
 */
...
public class PowerSetData {
	...
	// Method to call print all elements for set
	private void printElement(Set<Set<Integer>> ans) {
	...
	// Method to print all elements for list
	private void printElement(List<List<Integer>> ans) {
